...
class JsonContentExamplesTest {
    ...
    fun testSingleExampleWithSchemaClass() {
                ...
                path("/users/{id}") {
                    get {
                        ...
                        response("200", "Success") {
                            jsonContent(User::class, example = User(
                                id = 1,
                                name = "John Doe",
        ...
        val responseContent = jsonObj["paths"]?.jsonObject
            ?.get("/users/{id}")?.jsonObject
            ?.get("get")?.jsonObject
    ...
    fun testMultipleExamplesWithSchemaClass() {
        ...
        val requestContent = jsonObj["paths"]?.jsonObject
            ?.get("/users")?.jsonObject
            ?.get("post")?.jsonObject
            ?.get("requestBody")?.jsonObject
            ?.get("content")?.jsonObject
            ?.get("application/json")?.jsonObject
    ...
    fun testSchemaReferenceWithExamples() {
        ...
        val nameValue = nameUpdate["value"]?.jsonObject?.get("name")?.jsonPrimitive?.content
        ...
        val emailValue = emailUpdate["value"]?.jsonObject?.get("email")?.jsonPrimitive?.content
    ...
    fun testComprehensiveIntegrationExample() {
        ...
        val listResponse = jsonObj["paths"]?.jsonObject
            ?.get("/users")?.jsonObject
            ?.get("get")?.jsonObject
            ?.get("responses")?.jsonObject
            ?.get("200")?.jsonObject
        ...
        val errorResponse = jsonObj["paths"]?.jsonObject
            ?.get("/users")?.jsonObject
            ?.get("post")?.jsonObject
            ?.get("responses")?.jsonObject
            ?.get("400")?.jsonObject
