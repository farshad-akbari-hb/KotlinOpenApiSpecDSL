...
class ExampleSerializerTest {
    ...
    fun testRoundTripSerialization() {
        val originalExamples = listOf(
            ...
            Example(null, "Description 4", buildJsonArray { add(1); add(2); add(3) }, null),
    ...
    fun testDeserializeWithUnknownFields() {
        ...
        try {
            ...
            assertEquals(true, example.value?.jsonObject?.get("test")?.jsonPrimitive?.boolean)
        } catch (e: Exception) {
