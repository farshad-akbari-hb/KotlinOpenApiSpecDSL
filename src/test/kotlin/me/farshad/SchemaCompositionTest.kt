...
class SchemaCompositionTest {
    ...
    fun testOneOfWithStringReferences() {
        ...
        val schema = json["components"]?.jsonObject?.get("schemas")?.jsonObject?.get("PetOrCategory")?.jsonObject
    ...
    fun testOneOfWithKClasses() {
        ...
        val json = Json.parseToJsonElement(spec.toJson()).jsonObject
        val schema = json["components"]?.jsonObject?.get("schemas")?.jsonObject?.get("AccountType")?.jsonObject
        val oneOfArray = schema?.get("oneOf")?.jsonArray
        
        assertNotNull(oneOfArray)
        assertEquals(2, oneOfArray.size)
        assertEquals("#/components/schemas/PrivateAccountDto", oneOfArray[0].jsonObject["\$ref"]?.jsonPrimitive?.content)
        assertEquals("#/components/schemas/BusinessAccountDto", oneOfArray[1].jsonObject["\$ref"]?.jsonPrimitive?.content)
    }
    ...
    fun testAllOf() {
        ...
        val json = Json.parseToJsonElement(spec.toJson()).jsonObject
        val schema = json["components"]?.jsonObject?.get("schemas")?.jsonObject?.get("ComposedSchema")?.jsonObject
    ...
    fun testDiscriminator() {
        ...
        val json = Json.parseToJsonElement(spec.toJson()).jsonObject
        val schema = json["components"]?.jsonObject?.get("schemas")?.jsonObject?.get("Animal")?.jsonObject
    ...
    fun testInlineSchema() {
        ...
        val json = Json.parseToJsonElement(spec.toJson()).jsonObject
        val schema = json["components"]?.jsonObject?.get("schemas")?.jsonObject?.get("MixedOneOf")?.jsonObject
        val oneOfArray = schema?.get("oneOf")?.jsonArray
    ...
    fun testAnyOfAndNot() {
        ...
        val json = Json.parseToJsonElement(spec.toJson()).jsonObject
        val schema = json["components"]?.jsonObject?.get("schemas")?.jsonObject?.get("ComplexSchema")?.jsonObject
...
@Serializable
data class BaseDto(val id: String, val name: String)
